...
<div id="main" class="content">
    ...
    <?php get_template_part( 'template-parts/camp', 'leader' );?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 offset-sm-2 camp-video">

                <?php get_template_part( 'template-parts/campvideo' );?>
    ...
    <section class="camp-gallery">
        ...
        <div class="">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-<?php the_sub_field('width');?> image-item"
