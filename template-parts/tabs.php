            ...
            <div class="row">
				...
				while( have_rows('tabs') ): the_row(); //  ?>
                    <li role="presentation" class="<?php if($row == 1) {echo 'active';}?> nav-item">
                        <a href="#row<?php echo $row; ?>" role="tab" data-toggle="tab"
    ...
    <div class="bottom-section">
        ...
        <div class="container">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show <?php if($row == 1) {echo 'active';}?>" id="row<?php echo $row; ?>"
                    role="tabpanel">
                    <div class="row">
                        <div class="col-sm-7">
                            <h3><?php the_sub_field('heading'); ?></h3>
                            <?php the_sub_field('main_copy'); ?>
                            <p class="lodges">Our camps in the <?php the_sub_field('heading'); ?>:
                                <?php if( have_rows('lodges_in_this_area') ) :?>

                                <?php while( have_rows('lodges_in_this_area') ): the_row();?>
                                <a href="<?php the_sub_field('lodge_page'); ?>"
                                    class="inline-link"><?php the_sub_field('lodge_name'); ?></a>
                                <?php endwhile; endif; ?>
                            </p>
                        </div>
